...
minetest.register_on_dieplayer(function(player)
	force_detach(player)
		if submarineselfbak then
			minetest.sound_stop(submarineselfbak.soundPing)
			minetest.sound_stop(submarineselfbak.soundMotor)
		end
	return true
end)
...
function submmarines:register_submarine(name, prototype)
	minetest.register_entity("submmarines:"..name, {
		--hp_max = 10,
		physical = true,
		...
		on_punch = function(self, puncher)
			...
			if self.driver and puncher == self.driver then
				...
				--		or not inv:contains_item("main", "submmarines:"..name) then
				--	local leftover = inv:add_item("main", "submmarines:"..name)
		...
		on_step = function(self, dtime)
			...
			if self.driver then
				...
				--torpedo launch
				--if ctrl.aux1 then
				--	shoot_torpedo(self.object:getpos(), self.object:getyaw(), self, "submmarines:"..name.."_torpedo")
				--end
			...
			--			self.r3ckt = true
			--			local wreck = minetest.add_entity(self.object:getpos(), "submmarines:"..name .."_wreck")
	...
	minetest.register_craftitem("submmarines:"..name,{
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			submarine = minetest.add_entity(pointed_thing.under, "submmarines:"..name)
	...
	-- minetest.register_entity("submmarines:"..name.."_torpedo",{
	-- 	hp_max = 10,
	-- 	physical = true,
	-- 	collide_with_objects = true,
	...
	-- minetest.register_craftitem("submmarines:"..name.."_torpedo",{
	...
	-- 			return itemstack
	-- 		end
	-- 		torpedo = minetest.add_entity(pointed_thing.under, "submmarines:"..name.."_torpedo")
	...
	-- minetest.register_entity("submmarines:"..name.."_wreck",{
	-- 	hp_max = 10,
	-- 	physical = true,
	-- 	collide_with_objects = true,
	-- 	collisionbox = {-1,-1,-1, 1,1,1},
